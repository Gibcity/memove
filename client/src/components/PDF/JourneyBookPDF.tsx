...
import { sanitizeRichTextHtml } from '@memove/shared'
...
<body>
  ...
  <div class="cover-page">
    ...
    <div class="cover-footer">Made with memove</div>
  </div>
  ...
  <div class="closing-page">
    <div>
      ...
      <div class="closing-sub">Made with memove · ${new Date().getFullYear()}</div>
    </div>
  </div>
