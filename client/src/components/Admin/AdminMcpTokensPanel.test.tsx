...
describe('AdminMcpTokensPanel', () => {
  ...
  it('FE-ADMIN-MCP-003: token list renders correctly', async () => {
    ...
    expect(screen.getByText(/memove_abc/)).toBeInTheDocument();
    expect(screen.getByText(/memove_xyz/)).toBeInTheDocument();
  });
