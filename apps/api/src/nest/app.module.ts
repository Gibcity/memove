...
import { MemoveExceptionFilter } from './common/memove-exception.filter';
...
@Module({
  ...
  providers: [
    ...
    { provide: APP_FILTER, useClass: MemoveExceptionFilter },
