...
exports.MemoveExceptionFilter = void 0;
 ...
 */
let MemoveExceptionFilter = class MemoveExceptionFilter {
        ...
        if (exception instanceof common_1.HttpException) {
            ...
            if (body && typeof body === 'object') {
                ...
                const message = status < 500 ? (Array.isArray(raw) ? raw.join(', ') : String(raw ?? 'Error')) : 'Internal server error';
...
exports.MemoveExceptionFilter = MemoveExceptionFilter;
exports.MemoveExceptionFilter = MemoveExceptionFilter = __decorate([
    (0, common_1.Catch)()
], MemoveExceptionFilter);
