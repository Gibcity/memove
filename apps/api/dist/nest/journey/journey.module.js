...
const journey_public_controller_1 = require("./journey-public.controller");
...
exports.JourneyModule = JourneyModule = __decorate([
    (0, common_1.Module)({
        controllers: [journey_controller_1.JourneyController, journey_public_controller_1.JourneyPublicController],
        providers: [journey_service_1.JourneyService, journey_addon_guard_1.JourneyAddonGuard],
    })
], JourneyModule);
