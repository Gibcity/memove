...
exports.VOTER_DATA = exports.DMV_DATA = void 0;
...
function registerAdminTools(server, _userId, scopes) {
    ...
    for (const def of tools) {
        ...
        }, async (args) => (0, _shared_1.ok)(await def.handler({ relocation: {} }, args, String(_userId))));
    }
}
