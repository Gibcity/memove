...
exports.SYSTEM_NOTICES = void 0;
const conditions_js_1 = require("./conditions.js");
const database_js_1 = require("../db/database.js");
(0, conditions_js_1.registerPredicate)('whitespace-collision-detected', () => {
    const row = database_js_1.db.prepare("SELECT value FROM app_settings WHERE key = 'whitespace_migration_collision'").get();
