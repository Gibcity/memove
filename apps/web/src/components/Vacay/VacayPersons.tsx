  ...
  return (
    <div className="rounded-xl border p-3 bg-surface-card border-edge">
      ...
      {showInvite && ReactDOM.createPortal(
        <div className="fixed inset-0 flex items-center justify-center px-4 memove-backdrop-enter bg-[rgba(15,23,42,0.5)]" style={{ zIndex: 99990, paddingTop: 70 }}
          onClick={() => setShowInvite(false)}>
          <div className="memove-modal-enter rounded-2xl shadow-2xl w-full max-w-sm bg-surface-card"
      ...
      {showColorPicker && ReactDOM.createPortal(
        <div className="fixed inset-0 flex items-center justify-center px-4 memove-backdrop-enter bg-[rgba(15,23,42,0.5)]" style={{ zIndex: 99990, paddingTop: 70 }}
          ...
          <div className="memove-modal-enter rounded-2xl shadow-2xl w-full max-w-xs bg-surface-card"
            onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between p-5 border-b border-edge-secondary">
