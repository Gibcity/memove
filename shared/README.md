...
Single source of truth for memove's API contracts, expressed as [Zod](https://zod.dev) schemas
...
Both apps resolve `@memove/shared` to this package's TypeScript source:
...
The canonical **error envelope** is finalised in card **F5** (it must match memove's current
