...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle':
    'Ενεργοποιήστε ή απενεργοποιήστε λειτουργίες για να εξατομικεύσετε την εμπειρία σας στο memove.',
  ...
  'admin.weather.description':
    'Το memove χρησιμοποιεί το Open-Meteo ως πηγή δεδομένων καιρού. Το Open-Meteo είναι μια δωρεάν, ανοιχτού κώδικα υπηρεσία καιρού — δεν απαιτείται κλειδί API.',
  ...
  'admin.update.confirmText':
    'Το memove θα ενημερωθεί από {current} σε {version}. Ο server θα επανεκκινήσει αυτόματα στη συνέχεια.',
  ...
  'admin.update.dockerText':
    'Η εγκατάστασή σας memove εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε τις ακόλουθες εντολές στον server σας:',
  'admin.update.nonDockerText':
    'Αυτή η εγκατάσταση memove δεν εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε ξανά τη μέθοδο εγκατάστασης ή ενημέρωσης που χρησιμοποιήσατε — για παράδειγμα, στα Proxmox Community Scripts εκτελέστε την ενημέρωση από την κονσόλα LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Ο σκέτος τομέας στον οποίο δεσμεύονται τα passkeys, π.χ. memove.example.org. Αφήστε το κενό για να παραχθεί από το APP_URL. Η μεταγενέστερη αλλαγή του ακυρώνει τα υπάρχοντα passkeys.',
  'admin.passkey.origins': 'Επιτρεπόμενες προελεύσεις',
  'admin.passkey.originsHint':
    'Πλήρεις προελεύσεις χωρισμένες με κόμμα, π.χ. https://memove.example.org. Αφήστε το κενό για χρήση του APP_URL.',
