...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Miközben te a következő útvonaladat tervezed, ők a memove jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a memove Open Source maradhasson.',
  ...
  'settings.about.description':
    'A memove egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.',
  ...
  'settings.airtrail.writeBackHint':
    'Alapértelmezés szerint kikapcsolva: az AirTrail a hiteles forrás, és a memove csak olvas belőle. Kapcsold be, hogy a memove-ben végzett módosításokat visszaküldje az AirTrailbe.',
