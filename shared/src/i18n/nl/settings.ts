...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van memove. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat memove Open Source blijft.',
  ...
  'settings.about.description':
    "memove is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto's en nog veel meer — alles op één plek, op je eigen server.",
  ...
  'settings.airtrail.writeBackHint':
    'Standaard uit: AirTrail is de bron van waarheid en memove leest er alleen uit. Schakel in om in memove gemaakte wijzigingen terug te sturen naar AirTrail.',
