...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Während du deine nächste Route planst, planen diese Leute mit, wie memove weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit memove Open Source bleibt.',
  ...
  'settings.about.description':
    'memove ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  ...
  'settings.airtrail.writeBackHint':
    'Standardmäßig aus: AirTrail ist die maßgebliche Quelle und memove liest nur. Aktivieren, um in memove vorgenommene Änderungen zurück an AirTrail zu senden.',
