...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.update.confirmText':
    'memove will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your memove instance runs in Docker. To update to {version}, run the following commands on your server:',
  'admin.update.nonDockerText':
    'This memove instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:',
  ...
  'admin.passkey.rpIdHint':
    'The bare domain passkeys are bound to, e.g. memove.example.org. Leave empty to derive it from APP_URL. Changing it later invalidates existing passkeys.',
  'admin.passkey.origins': 'Allowed origins',
  'admin.passkey.originsHint':
    'Comma-separated full origins, e.g. https://memove.example.org. Leave empty to use APP_URL.',
