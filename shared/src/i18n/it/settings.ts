...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di memove. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere memove Open Source.',
  ...
  'settings.about.description':
    "memove è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.",
  ...
  'settings.airtrail.writeBackHint':
    'Disattivato per impostazione predefinita: AirTrail è la fonte attendibile e memove si limita a leggerlo. Attiva per inviare ad AirTrail le modifiche fatte in memove.',
