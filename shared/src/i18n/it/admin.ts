...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.update.confirmText':
    'memove verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText':
    'La tua istanza memove è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  'admin.update.nonDockerText':
    "Questa istanza memove non è in esecuzione in Docker. Per aggiornare alla versione {version}, riesegui il metodo di installazione o aggiornamento che hai usato — ad esempio, su Proxmox Community Scripts esegui l'aggiornamento dalla console LXC:",
  ...
  'admin.passkey.rpIdHint':
    'Il dominio puro a cui le passkey sono associate, es. memove.example.org. Lascia vuoto per derivarlo da APP_URL. Modificarlo in seguito invalida le passkey esistenti.',
  'admin.passkey.origins': 'Origini consentite',
  'admin.passkey.originsHint':
    'Origini complete separate da virgola, es. https://memove.example.org. Lascia vuoto per usare APP_URL.',
