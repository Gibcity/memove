...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost memove. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby memove zůstal Open Source.',
  ...
  'settings.about.description':
    'memove je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.',
  ...
  'settings.airtrail.writeBackHint':
    'Ve výchozím stavu vypnuto: AirTrail je zdrojem pravdy a memove z něj pouze čte. Zapněte, chcete-li odesílat úpravy provedené v memove zpět do AirTrail.',
