...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} wants access to your memove account. Please sign in first.', // en-fallback
  'oauth.authorize.loginButton': 'Sign in to memove', // en-fallback
  'oauth.authorize.requestLabel': 'Authorization Request', // en-fallback
  'oauth.authorize.requestDescription': 'This application is requesting access to your memove account.', // en-fallback
