...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.update.confirmText':
    'memove se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText':
    'Tu instancia de memove se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  'admin.update.nonDockerText':
    'Esta instancia de memove no se ejecuta en Docker. Para actualizar a {version}, vuelve a ejecutar el método de instalación o actualización que utilizaste; por ejemplo, en Proxmox Community Scripts ejecuta la actualización desde la consola LXC:',
  ...
  'admin.passkey.rpIdHint':
    'El dominio puro al que se vinculan las passkeys, p. ej. memove.example.org. Déjalo vacío para derivarlo de APP_URL. Cambiarlo más adelante invalida las passkeys existentes.',
  'admin.passkey.origins': 'Orígenes permitidos',
  'admin.passkey.originsHint':
    'Orígenes completos separados por comas, p. ej. https://memove.example.org. Déjalo vacío para usar APP_URL.',
