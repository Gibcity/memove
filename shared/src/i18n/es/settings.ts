...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de memove. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que memove siga siendo Open Source.',
  ...
  'settings.about.description':
    'memove es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.',
  ...
  'settings.airtrail.writeBackHint':
    'Desactivado por defecto: AirTrail es la fuente de referencia y memove solo lee de él. Actívalo para enviar a AirTrail los cambios hechos en memove.',
