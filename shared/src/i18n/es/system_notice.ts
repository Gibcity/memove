...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Bienvenido a memove',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de memove',
  ...
  'system_notice.v3_mcp.body':
    'La integración MCP ha sido completamente renovada. OAuth 2.1 es ahora el método de autenticación recomendado. Los tokens estáticos (memove_…) están obsoletos y se eliminarán en una versión futura.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos memove_ obsoletos',
