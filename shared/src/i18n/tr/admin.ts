...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    "memove, hava durumu veri kaynağı olarak Open-Meteo'yu kullanıyor. Open-Meteo ücretsiz, açık kaynaklı bir hava durumu hizmetidir; API anahtarı gerekmez.",
  ...
  'admin.update.confirmText':
    'memove, {current} sürümünden {version} sürümüne güncellenecek. Sunucu daha sonra otomatik olarak yeniden başlatılacaktır.',
  ...
  'admin.update.dockerText':
    "memove örneğiniz Docker'da çalışır. {version} sürümüne güncellemek için sunucunuzda aşağıdaki komutları çalıştırın:",
  'admin.update.nonDockerText':
    'Bu memove örneği Docker üzerinde çalışmıyor. {version} sürümüne güncellemek için kullandığınız kurulum veya güncelleme yöntemini yeniden çalıştırın — örneğin Proxmox Community Scripts kullanıyorsanız güncellemeyi LXC konsolundan çalıştırın:',
  ...
  'admin.passkey.rpIdHint':
    'Passkey’lerin bağlı olduğu yalın alan adı, ör. memove.example.org. APP_URL’den türetmek için boş bırakın. Daha sonra değiştirmek mevcut passkey’leri geçersiz kılar.',
  'admin.passkey.origins': 'İzin verilen kaynaklar',
  'admin.passkey.originsHint':
    'Virgülle ayrılmış tam kaynaklar, ör. https://memove.example.org. APP_URL kullanmak için boş bırakın.',
