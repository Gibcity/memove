...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan memove's future. Their monthly contribution goes straight into development and real hours spent — so memove stays Open Source.",
  ...
  'settings.about.description':
    'memove, seyahatlerinizi ilk fikirden son anıya kadar organize etmenize yardımcı olan, kendi kendine barındırılan bir seyahat planlayıcıdır. Gün planlaması, bütçe, paketleme listeleri, fotoğraflar ve çok daha fazlası; hepsi tek bir yerde, kendi sunucunuzda.',
  ...
  'settings.airtrail.writeBackHint':
    'Varsayılan olarak kapalı: AirTrail asıl kaynaktır ve memove yalnızca okur. memove’te yapılan değişiklikleri AirTrail’e geri göndermek için açın.',
