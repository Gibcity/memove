...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość memove. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby memove pozostał Open Source.',
  ...
  'settings.about.description':
    'memove to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
  ...
  'settings.airtrail.writeBackHint':
    'Domyślnie wyłączone: AirTrail jest źródłem prawdy, a memove tylko z niego odczytuje. Włącz, aby wysyłać zmiany wprowadzone w memove z powrotem do AirTrail.',
