...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.update.confirmText':
    'memove zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText':
    'Twoja instancja memove działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  'admin.update.nonDockerText':
    'Ta instancja memove nie działa w Dockerze. Aby zaktualizować do {version}, uruchom ponownie metodę instalacji lub aktualizacji, której użyłeś — na przykład w Proxmox Community Scripts uruchom aktualizację z konsoli LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Sama domena, do której przypisane są klucze dostępu, np. memove.example.org. Pozostaw puste, aby wyprowadzić ją z APP_URL. Późniejsza zmiana unieważnia istniejące klucze dostępu.',
  'admin.passkey.origins': 'Dozwolone origins',
  'admin.passkey.originsHint':
    'Pełne origins oddzielone przecinkami, np. https://memove.example.org. Pozostaw puste, aby użyć APP_URL.',
