...
const admin = {
	...
	"admin.addons.subtitle": "Activez ou désactivez des fonctionnalités pour personnaliser votre expérience memove.",
	...
	"admin.weather.description": "memove utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.",
	...
	"admin.github.support": "Aidez à poursuivre le développement de memove",
	"admin.github.error": "Impossible de charger les versions",
	"admin.github.by": "par",
	"admin.update.available": "Mise à jour disponible",
	"admin.update.text": "memove {version} est disponible. Vous utilisez {current}.",
	...
	"admin.update.confirmText": "memove sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.",
	...
	"admin.update.dockerText": "Votre instance memove fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :",
	"admin.update.nonDockerText": "Cette instance memove ne fonctionne pas dans Docker. Pour mettre à jour vers {version}, relancez la méthode d'installation ou de mise à jour que vous avez utilisée — par exemple, sur Proxmox Community Scripts, lancez la mise à jour depuis la console LXC :",
	...
	"admin.passkey.cardHint": "Permettez aux utilisateurs de se connecter avec des passkeys (WebAuthn). Désactivé par défaut.",
	"admin.passkey.login": "Activer la connexion par passkey",
	"admin.passkey.loginHint": "Affiche une option « Se connecter avec une passkey » et permet aux utilisateurs d'enregistrer des passkeys dans leurs paramètres.",
	"admin.passkey.notConfigured": "Aucun domaine WebAuthn ne peut encore être résolu pour ce déploiement. Définissez APP_URL ou le Relying Party ID ci-dessous — les passkeys restent masquées jusque-là.",
	"admin.passkey.rpId": "Relying Party ID (domaine)",
	"admin.passkey.rpIdHint": "Le domaine nu auquel les passkeys sont liées, ex. memove.example.org. Laissez vide pour le déduire d'APP_URL. Le modifier ultérieurement invalide les passkeys existantes.",
	"admin.passkey.origins": "Origines autorisées",
	"admin.passkey.originsHint": "Origines complètes séparées par des virgules, ex. https://memove.example.org. Laissez vide pour utiliser APP_URL.",
	"admin.passkey.reset": "Réinitialiser les passkeys",
	"admin.passkey.resetHint": "Supprime toutes les passkeys de cet utilisateur (ex. en cas d'appareil perdu). Il pourra toujours se connecter avec son mot de passe.",
...
//#endregion
//#region src/i18n/fr/airport.ts
const airport = { "airport.searchPlaceholder": "Code ou ville de l'aéroport (ex. FRA)" };
//#endregion
//#region src/i18n/fr/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/fr/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/fr/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/fr/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Créé avec memove",
...
const login = {
	...
	"login.createAdminHint": "Configurez le premier compte administrateur pour memove.",
...
//#endregion
//#region src/i18n/fr/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} est maintenant disponible",
...
//#endregion
//#region src/i18n/fr/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} est maintenant disponible.",
	"notifications.versionAvailable.button": "Voir les détails"
};
//#endregion
//#region src/i18n/fr/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Recherche chaque lieu importé pour ajouter photos, adresse et coordonnées. Utilise votre clé Google Maps."
};
//#endregion
//#region src/i18n/fr/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/fr/register.ts
const register = {
...
//#endregion
//#region src/i18n/fr/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/fr/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/fr/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Lors de l'optimisation d'une journée, commencez l'itinéraire à l'hôtel où vous vous réveillez et terminez-le à celui où vous arrivez le soir.",
	...
	"settings.about.supporters.title": "Compagnons de voyage pour memove",
	"settings.about.supporters.subtitle": "Pendant que tu planifies ton prochain itinéraire, ces personnes aident à planifier l'avenir de memove. Leur contribution mensuelle va directement au développement et aux heures réellement passées — pour que memove reste Open Source.",
	...
	"settings.about.description": "memove est un planificateur de voyage auto-hébergé qui vous aide à organiser vos voyages de la première idée au dernier souvenir. Planification journalière, budget, listes de bagages, photos et bien plus — le tout au même endroit, sur votre propre serveur.",
	...
	"settings.passkey.description": "Connectez-vous plus rapidement et de façon résistante au phishing avec une passkey — votre empreinte digitale, votre visage, votre code PIN ou une clé matérielle. Votre mot de passe reste disponible en secours.",
	"settings.passkey.notConfigured": "Les passkeys sont activées mais ne sont pas encore entièrement configurées sur ce serveur. Demandez à votre administrateur de définir le domaine WebAuthn.",
	"settings.passkey.add": "Ajouter une passkey",
	"settings.passkey.addTitle": "Ajouter une passkey",
	"settings.passkey.passwordPrompt": "Confirmez votre mot de passe actuel, puis suivez les instructions de votre appareil.",
	...
	"settings.airtrail.writeBackHint": "Désactivé par défaut : AirTrail fait référence et memove se contente de le lire. Activez pour renvoyer vers AirTrail les modifications faites dans memove.",
...
//#endregion
//#region src/i18n/fr/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Photos** dans le planificateur ont été supprimées. Tes photos sont en sécurité — memove n'a jamais modifié ta bibliothèque Immich ou Synology.\n\nLes photos vivent désormais dans l'addon **Journey**. Journey est optionnel — s'il n'est pas encore disponible, demande à ton admin de l'activer dans Admin → Modules.",
	...
	"system_notice.v3_mcp.title": "MCP\xA0: mise à niveau OAuth 2.1",
	"system_notice.v3_mcp.body": "L'intégration MCP a été entièrement repensée. OAuth 2.1 est désormais la méthode d'authentification recommandée. Les tokens statiques (memove_…) sont dépréciés et seront supprimés dans une future version.",
...
//#endregion
//#region src/i18n/fr/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Partagez votre plan de vacances avec d'autres utilisateurs memove",
	"vacay.owner": "Propriétaire",
	"vacay.shareEmailPlaceholder": "E-mail de l'utilisateur memove",
	...
	"vacay.inviteHint": "Invitez un autre utilisateur memove à partager un calendrier de vacances combiné.",
