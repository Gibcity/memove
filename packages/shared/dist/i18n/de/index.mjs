...
const admin = {
	...
	"admin.addons.subtitle": "Aktiviere oder deaktiviere Funktionen, um memove nach deinen Wünschen anzupassen.",
	...
	"admin.weather.description": "memove nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.",
	...
	"admin.github.by": "von",
	"admin.github.support": "Hilft mir, memove weiterzuentwickeln",
	"admin.update.available": "Update verfügbar",
	"admin.update.text": "memove {version} ist verfügbar. Du verwendest {current}.",
	...
	"admin.update.confirmText": "memove wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.",
	...
	"admin.update.dockerText": "Deine memove-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:",
	"admin.update.nonDockerText": "Diese memove-Instanz läuft nicht in Docker. Um auf {version} zu aktualisieren, führe die Installations- oder Update-Methode erneut aus, die du verwendet hast — bei Proxmox Community Scripts startest du das Update zum Beispiel über die LXC-Konsole:",
	...
	"admin.passkey.loginHint": "Zeigt die Option \"Mit Passkey anmelden\" und erlaubt Benutzern, in ihren Einstellungen Passkeys zu registrieren.",
	"admin.passkey.notConfigured": "Für diese Installation ist noch keine WebAuthn-Domain auflösbar. Lege unten APP_URL oder die Relying Party ID fest — bis dahin bleiben Passkeys ausgeblendet.",
	"admin.passkey.rpId": "Relying Party ID (Domain)",
	"admin.passkey.rpIdHint": "Die reine Domain, an die Passkeys gebunden sind, z. B. memove.example.org. Leer lassen, um sie aus APP_URL abzuleiten. Eine spätere Änderung macht bestehende Passkeys ungültig.",
	"admin.passkey.origins": "Erlaubte Origins",
	"admin.passkey.originsHint": "Vollständige Origins, durch Komma getrennt, z. B. https://memove.example.org. Leer lassen, um APP_URL zu verwenden.",
	"admin.passkey.reset": "Passkeys zurücksetzen",
	"admin.passkey.resetHint": "Entfernt alle Passkeys dieses Benutzers (z. B. bei einem verlorenen Gerät). Die Anmeldung mit Passwort bleibt weiterhin möglich.",
...
//#endregion
//#region src/i18n/de/airport.ts
const airport = { "airport.searchPlaceholder": "Flughafencode oder Stadt (z. B. FRA)" };
//#endregion
//#region src/i18n/de/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/de/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/de/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/de/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Erstellt mit memove",
	"journey.pdf.day": "Tag",
...
const login = {
	...
	"login.createAdminHint": "Erstelle das erste Admin-Konto für memove.",
...
//#endregion
//#region src/i18n/de/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} ist jetzt verfügbar",
...
//#endregion
//#region src/i18n/de/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} ist jetzt verfügbar.",
	"notifications.versionAvailable.button": "Details anzeigen"
};
//#endregion
//#region src/i18n/de/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Sucht jeden importierten Ort nach, um Fotos, Adresse und Kontaktdaten zu ergänzen. Nutzt deinen Google-Maps-Key."
};
//#endregion
//#region src/i18n/de/planner.ts
const planner = {
	"planner.places": "Orte",
...
//#endregion
//#region src/i18n/de/register.ts
const register = {
...
//#endregion
//#region src/i18n/de/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/de/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/de/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Beim Optimieren eines Tages startet die Route an der Unterkunft, in der du aufwachst, und endet an der, in die du am Abend eincheckst.",
	...
	"settings.about.supporters.title": "Reisebegleitung für memove",
	"settings.about.supporters.subtitle": "Während du deine nächste Route planst, planen diese Leute mit, wie memove weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit memove Open Source bleibt.",
	...
	"settings.about.description": "memove ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.",
	...
	"settings.passkey.description": "Melde dich schneller und phishing-resistent mit einem Passkey an — per Fingerabdruck, Gesicht, PIN oder Hardware-Schlüssel. Dein Passwort bleibt als Backup erhalten.",
	"settings.passkey.notConfigured": "Passkeys sind aktiviert, aber auf diesem Server noch nicht vollständig eingerichtet. Bitte deinen Administrator, die WebAuthn-Domain festzulegen.",
	...
	"settings.airtrail.writeBackHint": "Standardmäßig aus: AirTrail ist die maßgebliche Quelle und memove liest nur. Aktivieren, um in memove vorgenommene Änderungen zurück an AirTrail zu senden.",
...
//#endregion
//#region src/i18n/de/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Fotos** im Trip-Planer wurden entfernt. Deine Fotos sind sicher — memove hat deine Immich- oder Synology-Bibliothek nie verändert.\n\nFotos befinden sich jetzt im **Journey**-Addon. Journey ist optional — falls es noch nicht verfügbar ist, bitte deinen Admin, es unter Admin → Addons zu aktivieren.",
	...
	"system_notice.v3_mcp.body": "Die MCP-Integration wurde vollständig überarbeitet. OAuth 2.1 ist jetzt die empfohlene Authentifizierungsmethode. Statische Tokens (memove_…) sind veraltet und werden in einer zukünftigen Version entfernt.",
...
//#endregion
//#region src/i18n/de/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Teile deinen Urlaubsplan mit anderen memove-Benutzern",
	"vacay.owner": "Besitzer",
	"vacay.shareEmailPlaceholder": "E-Mail des memove-Benutzers",
	...
	"vacay.inviteHint": "Lade einen anderen memove-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.",
