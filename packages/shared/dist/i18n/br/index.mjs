...
const admin = {
	...
	"admin.addons.subtitle": "Ative ou desative recursos para personalizar sua experiência no memove.",
	...
	"admin.weather.description": "O memove usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.",
	...
	"admin.github.by": "por",
	"admin.github.support": "Ajuda a continuar desenvolvendo o memove",
	"admin.update.available": "Atualização disponível",
	"admin.update.text": "O memove {version} está disponível. Você está na {current}.",
	"admin.update.button": "Ver no GitHub",
	"admin.update.install": "Instalar atualização",
	"admin.update.confirmTitle": "Instalar atualização?",
	"admin.update.confirmText": "O memove será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.",
	...
	"admin.update.dockerText": "Sua instância memove roda no Docker. Para atualizar para {version}, execute no servidor:",
	"admin.update.nonDockerText": "Esta instância do memove não está rodando no Docker. Para atualizar para {version}, execute novamente o método de instalação ou atualização que você usou — por exemplo, no Proxmox Community Scripts, execute a atualização a partir do console do LXC:",
	...
	"admin.passkey.loginHint": "Mostra a opção \"Entrar com uma passkey\" e permite que os usuários cadastrem passkeys nas configurações.",
	"admin.passkey.notConfigured": "Nenhum domínio WebAuthn é resolvido para esta instalação ainda. Defina APP_URL ou o Relying Party ID abaixo — as passkeys ficam ocultas até lá.",
	"admin.passkey.rpId": "Relying Party ID (domínio)",
	"admin.passkey.rpIdHint": "O domínio puro ao qual as passkeys ficam vinculadas, ex.: memove.example.org. Deixe vazio para derivá-lo de APP_URL. Alterá-lo depois invalida as passkeys existentes.",
	"admin.passkey.origins": "Origens permitidas",
	"admin.passkey.originsHint": "Origens completas separadas por vírgula, ex.: https://memove.example.org. Deixe vazio para usar APP_URL.",
	"admin.passkey.reset": "Redefinir passkeys",
	"admin.passkey.resetHint": "Remove todas as passkeys deste usuário (ex.: em caso de perda do dispositivo). Ele ainda poderá entrar com a senha.",
...
//#endregion
//#region src/i18n/br/airport.ts
const airport = { "airport.searchPlaceholder": "Código ou cidade do aeroporto (ex. FRA)" };
//#endregion
//#region src/i18n/br/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/br/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/br/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/br/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Feito com memove",
	"journey.pdf.day": "Dia",
...
const login = {
	...
	"login.createAdminHint": "Configure a primeira conta de administrador do memove.",
...
//#endregion
//#region src/i18n/br/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} está disponível",
...
//#endregion
//#region src/i18n/br/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} já está disponível.",
	"notifications.versionAvailable.button": "Ver detalhes"
};
//#endregion
//#region src/i18n/br/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Busca cada lugar importado para adicionar fotos, endereço e contato. Usa sua chave do Google Maps."
};
//#endregion
//#region src/i18n/br/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/br/register.ts
const register = {
...
//#endregion
//#region src/i18n/br/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/br/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/br/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Ao otimizar um dia, comece a rota no hotel onde você acorda e termine no hotel em que você faz check-in à noite.",
	...
	"settings.about.supporters.title": "Companheiros de viagem do memove",
	"settings.about.supporters.subtitle": "Enquanto você planeja sua próxima rota, essas pessoas planejam junto o futuro do memove. A contribuição mensal delas vai direto para o desenvolvimento e horas reais investidas — para o memove continuar Open Source.",
	...
	"settings.about.description": "memove é um planejador de viagens auto-hospedado que ajuda você a organizar suas viagens da primeira ideia à última lembrança. Planejamento diário, orçamento, listas de bagagem, fotos e muito mais — tudo em um só lugar, no seu próprio servidor.",
	...
	"settings.passkey.description": "Entre mais rápido e com proteção contra phishing usando uma passkey — sua impressão digital, rosto, PIN ou uma chave de segurança física. Sua senha continua disponível como reserva.",
	"settings.passkey.notConfigured": "As passkeys estão ativadas, mas ainda não foram totalmente configuradas neste servidor. Peça ao administrador para definir o domínio WebAuthn.",
	...
	"settings.airtrail.writeBackHint": "Desativado por padrão: o AirTrail é a fonte da verdade e o memove apenas lê dele. Ative para enviar ao AirTrail as alterações feitas no memove.",
...
//#endregion
//#region src/i18n/br/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Fotos** no Planejador de Viagens foram removidas. Suas fotos estão seguras — o memove nunca modificou sua biblioteca Immich ou Synology.\n\nAs fotos agora vivem no addon **Journey**. Journey é opcional — se ainda não estiver disponível, peça ao seu admin para ativá-lo em Admin → Addons.",
	...
	"system_notice.v3_mcp.body": "A integração MCP foi completamente reformulada. OAuth 2.1 agora é o método de autenticação recomendado. Tokens estáticos (memove_…) foram descontinuados e serão removidos em uma versão futura.",
...
//#endregion
//#region src/i18n/br/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Compartilhe seu plano de férias com outros usuários do memove",
	"vacay.owner": "Proprietário",
	"vacay.shareEmailPlaceholder": "E-mail do usuário memove",
	...
	"vacay.inviteHint": "Convide outro usuário memove para compartilhar um calendário de férias combinado.",
