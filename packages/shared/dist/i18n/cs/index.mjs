...
const admin = {
	...
	"admin.addons.subtitle": "Zapněte nebo vypněte funkce a přizpůsobte si memove.",
	...
	"admin.github.by": "od",
	"admin.github.support": "Pomáhá udržovat vývoj memove",
	"admin.weather.title": "Data o počasí",
	"admin.weather.badge": "Od 24. března 2026",
	"admin.weather.description": "memove používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.",
	...
	"admin.update.text": "memove {version} je k dispozici. Aktuálně používáte verzi {current}.",
	...
	"admin.update.confirmText": "memove bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.",
	...
	"admin.update.dockerText": "Váš memove běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:",
	"admin.update.nonDockerText": "Tato instance memove neběží v Dockeru. Pro aktualizaci na verzi {version} znovu spusťte instalační nebo aktualizační metodu, kterou jste použili — například u Proxmox Community Scripts spusťte aktualizaci z konzole LXC:",
	...
	"admin.passkey.cardHint": "Umožněte uživatelům přihlašovat se pomocí přístupových klíčů (WebAuthn). Ve výchozím nastavení vypnuto.",
	"admin.passkey.login": "Povolit přihlášení přístupovým klíčem",
	"admin.passkey.loginHint": "Zobrazí možnost „Přihlásit se pomocí přístupového klíče“ a umožní uživatelům zaregistrovat přístupové klíče v nastavení.",
	"admin.passkey.notConfigured": "Pro toto nasazení zatím nelze určit žádnou doménu WebAuthn. Nastavte níže APP_URL nebo Relying Party ID — do té doby zůstanou přístupové klíče skryté.",
	"admin.passkey.rpId": "Relying Party ID (doména)",
	"admin.passkey.rpIdHint": "Holá doména, ke které jsou přístupové klíče vázány, např. memove.example.org. Ponechte prázdné, aby se odvodila z APP_URL. Pozdější změna zneplatní stávající přístupové klíče.",
	"admin.passkey.origins": "Povolené origins",
	"admin.passkey.originsHint": "Úplné origins oddělené čárkou, např. https://memove.example.org. Ponechte prázdné pro použití APP_URL.",
	"admin.passkey.reset": "Resetovat přístupové klíče",
	"admin.passkey.resetHint": "Odebere všechny přístupové klíče tohoto uživatele (např. při ztrátě zařízení). Stále se může přihlásit svým heslem.",
...
//#endregion
//#region src/i18n/cs/airport.ts
const airport = { "airport.searchPlaceholder": "Kód letiště nebo město (např. FRA)" };
//#endregion
//#region src/i18n/cs/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/cs/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/cs/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/cs/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Vytvořeno pomocí memove",
	"journey.pdf.day": "Den",
...
const login = {
	...
	"login.createAdminHint": "Nastavte první administrátorský účet pro memove.",
...
//#endregion
//#region src/i18n/cs/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} je nyní dostupný",
...
//#endregion
//#region src/i18n/cs/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} je nyní k dispozici.",
	"notifications.versionAvailable.button": "Zobrazit podrobnosti"
};
//#endregion
//#region src/i18n/cs/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Vyhledá každé importované místo a doplní fotky, adresu a kontakty. Vyžaduje klíč Google Maps."
};
//#endregion
//#region src/i18n/cs/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/cs/register.ts
const register = {
...
//#endregion
//#region src/i18n/cs/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/cs/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/cs/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Při optimalizaci dne začne trasa v hotelu, ve kterém se ráno probudíte, a skončí v hotelu, do kterého se večer ubytujete.",
	...
	"settings.about.supporters.title": "Společníci na cestě s memove",
	"settings.about.supporters.subtitle": "Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost memove. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby memove zůstal Open Source.",
	...
	"settings.about.description": "memove je samohostovaný plánovač cest, který vám pomůže organizovat výlety od prvního nápadu po poslední vzpomínku. Denní plánování, rozpočet, balicí seznamy, fotky a mnoho dalšího — vše na jednom místě, na vašem vlastním serveru.",
	...
	"settings.passkey.description": "Přihlašujte se rychleji a s ochranou proti phishingu pomocí přístupového klíče — otiskem prstu, obličejem, PINem nebo hardwarovým klíčem. Vaše heslo zůstává jako záloha.",
	"settings.passkey.notConfigured": "Přístupové klíče jsou povoleny, ale na tomto serveru zatím nejsou plně nastaveny. Požádejte správce o nastavení domény WebAuthn.",
	...
	"settings.airtrail.writeBackHint": "Ve výchozím stavu vypnuto: AirTrail je zdrojem pravdy a memove z něj pouze čte. Zapněte, chcete-li odesílat úpravy provedené v memove zpět do AirTrail.",
...
//#endregion
//#region src/i18n/cs/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Fotografie** v Plánovacím nástroji byly odebrány. Vaše fotografie jsou v bezpečí — memove nikdy neupravoval vaši knihovnu Immich nebo Synology.\n\nFotografie jsou nyní dostupné v doplňku **Journey**. Journey je volitelný — pokud ještě není k dispozici, požádejte svého správce, aby ho aktivoval v Admin → Doplňky.",
	...
	"system_notice.v3_mcp.body": "Integrace MCP byla kompletně přepracována. OAuth 2.1 je nyní doporučenou metodou ověřování. Statické tokeny (memove_…) jsou zastaralé a budou v budoucí verzi odstraněny.",
...
//#endregion
//#region src/i18n/cs/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Sdílejte svůj plán dovolené s ostatními uživateli memove",
	"vacay.owner": "Vlastník",
	"vacay.shareEmailPlaceholder": "E-mail uživatele memove",
	...
	"vacay.inviteHint": "Pozvěte jiného uživatele memove ke sdílení společného kalendáře dovolených.",
