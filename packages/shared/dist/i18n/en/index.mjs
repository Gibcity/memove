...
const admin = {
	...
	"admin.defaultSettings.mapProviderHint": "The default map for everyone on this instance. Each user can still override it in their own settings.",
	"admin.defaultSettings.providerLeaflet": "Standard (free)",
	"admin.defaultSettings.providerMapbox": "Mapbox (3D)",
	"admin.defaultSettings.mapboxToken": "Shared Mapbox token",
	"admin.defaultSettings.mapboxTokenHint": "Used for every user who has not entered their own token — so the whole instance gets Mapbox without sharing the key individually. Stored encrypted.",
	...
	"admin.addons.subtitle": "Enable or disable features to customize your memove experience.",
	...
	"admin.weather.description": "memove uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.",
	...
	"admin.github.by": "by",
	"admin.github.support": "Helps me keep building memove",
	"admin.update.available": "Update available",
	"admin.update.text": "memove {version} is available. You are running {current}.",
	"admin.update.button": "View on GitHub",
	"admin.update.install": "Install Update",
	"admin.update.confirmTitle": "Install Update?",
	"admin.update.confirmText": "memove will be updated from {current} to {version}. The server will restart automatically afterwards.",
	...
	"admin.update.dockerText": "Your memove instance runs in Docker. To update to {version}, run the following commands on your server:",
	"admin.update.nonDockerText": "This memove instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:",
	...
	"admin.passkey.notConfigured": "No WebAuthn domain resolves for this deployment yet. Set APP_URL or the Relying Party ID below — passkeys stay hidden until then.",
	"admin.passkey.rpId": "Relying Party ID (domain)",
	"admin.passkey.rpIdHint": "The bare domain passkeys are bound to, e.g. memove.example.org. Leave empty to derive it from APP_URL. Changing it later invalidates existing passkeys.",
	"admin.passkey.origins": "Allowed origins",
	"admin.passkey.originsHint": "Comma-separated full origins, e.g. https://memove.example.org. Leave empty to use APP_URL.",
	"admin.passkey.reset": "Reset passkeys",
	"admin.passkey.resetHint": "Remove all of this user's passkeys (e.g. on a lost device). They can still sign in with their password.",
	"admin.passkey.resetConfirm": "Remove all passkeys for {name}?",
	"admin.passkey.resetDone": "Removed {count} passkey(s)"
};
//#endregion
//#region src/i18n/en/airport.ts
const airport = { "airport.searchPlaceholder": "Airport code or city (e.g. FRA)" };
//#endregion
//#region src/i18n/en/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/en/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/en/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/en/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Made with memove",
	"journey.pdf.day": "Day",
...
const login = {
	...
	"login.createAdminHint": "Set up the first admin account for memove.",
...
//#endregion
//#region src/i18n/en/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} is now available",
...
//#endregion
//#region src/i18n/en/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} is now available.",
...
//#endregion
//#region src/i18n/en/register.ts
const register = {
...
//#endregion
//#region src/i18n/en/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/en/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/en/settings.ts
const settings = {
	...
	"settings.mapPoiPillHint": "Show a category pill on the trip map to find nearby restaurants, hotels and more from OpenStreetMap.",
	"settings.blurBookingCodes": "Blur Booking Codes",
	"settings.optimizeFromAccommodation": "Optimize route from accommodation",
	"settings.optimizeFromAccommodationHint": "When optimizing a day, start the route at the hotel you wake up in and end it at the one you check into that evening.",
	...
	"settings.about.supporters.title": "Travel companions for memove",
	...
	"settings.about.description": "memove is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.",
	...
	"settings.passkey.description": "Sign in faster and phishing-resistant with a passkey — your fingerprint, face, PIN, or a hardware key. Your password stays as a backup.",
	"settings.passkey.notConfigured": "Passkeys are enabled but not fully configured on this server yet. Ask your administrator to set the WebAuthn domain.",
	...
	"settings.airtrail.writeBackHint": "Off by default: AirTrail is the source of truth and memove only reads from it. Turn on to push edits made in memove back to AirTrail.",
...
const system_notice = {
	...
	"system_notice.v3_mcp.body": "The MCP integration has been fully overhauled. OAuth 2.1 is now the recommended auth method. Legacy static tokens (memove_…) are deprecated and will be removed in a future release.",
...
//#endregion
//#region src/i18n/en/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Share your vacation plan with other memove users",
	"vacay.owner": "Owner",
	"vacay.shareEmailPlaceholder": "Email of memove user",
	...
	"vacay.inviteHint": "Invite another memove user to share a combined vacation calendar.",
