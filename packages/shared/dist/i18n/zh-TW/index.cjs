//#region src/i18n/zh-TW/admin.ts
const admin = {
	...
	"admin.addons.subtitle": "啟用或停用功能以自定義你的 memove 體驗。",
	...
	"admin.weather.description": "memove 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。",
	...
	"admin.github.support": "幫助我繼續開發 memove",
	"admin.github.error": "載入版本失敗",
	"admin.github.by": "作者",
	"admin.update.available": "有可用更新",
	"admin.update.text": "memove {version} 已釋出。你當前使用的是 {current}。",
	"admin.update.button": "在 GitHub 檢視",
	"admin.update.install": "安裝更新",
	"admin.update.confirmTitle": "確定安裝更新？",
	"admin.update.confirmText": "memove 將從 {current} 更新到 {version}。伺服器將自動重啟。",
	...
	"admin.update.dockerText": "你的 memove 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：",
	"admin.update.nonDockerText": "此 memove 例項並非執行在 Docker 中。要更新到 {version}，請重新執行你當初使用的安裝或更新方式——例如在 Proxmox Community Scripts 上，請從 LXC 主控臺執行更新：",
	...
	"admin.passkey.notConfigured": "此部署尚未解析出任何 WebAuthn 網域。請設定下方的 APP_URL 或 Relying Party ID——在此之前 Passkey 將保持隱藏。",
	"admin.passkey.rpId": "Relying Party ID（網域）",
	"admin.passkey.rpIdHint": "Passkey 綁定的純網域，例如 memove.example.org。留空則從 APP_URL 推導。日後變更將使現有 Passkey 失效。",
	"admin.passkey.origins": "允許的來源",
	"admin.passkey.originsHint": "以逗號分隔的完整來源，例如 https://memove.example.org。留空則使用 APP_URL。",
...
//#endregion
//#region src/i18n/zh-TW/airport.ts
const airport = { "airport.searchPlaceholder": "機場代碼或城市（例如 FRA）" };
//#endregion
//#region src/i18n/zh-TW/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/zh-TW/backup.ts
const backup = {
	"backup.title": "資料備份",
...
//#endregion
//#region src/i18n/zh-TW/budget.ts
const budget = {
	"budget.title": "預算",
...
//#endregion
//#region src/i18n/zh-TW/categories.ts
const categories = {
	"categories.title": "分類",
...
//#endregion
//#region src/i18n/zh-TW/collab.ts
const collab = {
	"collab.tabs.chat": "聊天",
...
//#endregion
//#region src/i18n/zh-TW/common.ts
const common = {
	"common.save": "儲存",
...
//#endregion
//#region src/i18n/zh-TW/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/zh-TW/dayplan.ts
const dayplan = {
...
//#endregion
//#region src/i18n/zh-TW/files.ts
const files = {
	"files.title": "檔案",
...
//#endregion
//#region src/i18n/zh-TW/inspector.ts
const inspector = {
...
//#endregion
//#region src/i18n/zh-TW/journey.ts
const journey = {
	...
	"journey.pdf.madeWith": "由 memove 製作",
	"journey.pdf.day": "第",
...
//#endregion
//#region src/i18n/zh-TW/login.ts
const login = {
	...
	"login.createAdminHint": "為 memove 設定第一個管理員賬戶。",
...
//#endregion
//#region src/i18n/zh-TW/members.ts
const members = {
...
//#endregion
//#region src/i18n/zh-TW/memories.ts
const memories = {
	"memories.title": "照片",
...
//#endregion
//#region src/i18n/zh-TW/notif.ts
const notif = {
	...
	"notif.version_available.text": "memove {version} 現已推出",
...
//#endregion
//#region src/i18n/zh-TW/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} 現已推出。",
	"notifications.versionAvailable.button": "查看詳情"
};
//#endregion
//#region src/i18n/zh-TW/oauth.ts
const oauth = {
...
//#endregion
//#region src/i18n/zh-TW/packing.ts
const packing = {
	"packing.title": "行李清單",
...
//#endregion
//#region src/i18n/zh-TW/photos.ts
const photos = {
	"photos.title": "照片",
...
//#endregion
//#region src/i18n/zh-TW/places.ts
const places = {
...
//#endregion
//#region src/i18n/zh-TW/planner.ts
const planner = {
	"planner.places": "地點",
	"planner.bookings": "預訂",
...
//#endregion
//#region src/i18n/zh-TW/register.ts
const register = {
...
//#endregion
//#region src/i18n/zh-TW/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/zh-TW/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/zh-TW/settings.ts
const settings = {
	"settings.title": "設定",
	...
	"settings.optimizeFromAccommodationHint": "最佳化某一天的行程時,路線從你早上起床的飯店出發,並在你當晚入住的飯店結束。",
	...
	"settings.about.supporters.title": "與 memove 同行的夥伴",
	"settings.about.supporters.subtitle": "當你規劃下一段路線時，這些人也在一起規劃 memove 的未來。他們每月的支持直接用於開發與實際投入的時間——讓 memove 保持開源。",
	...
	"settings.about.description": "memove 是一款自架旅遊規劃器，幫助您從最初構想到最後回憶，整理每次旅行。日程規劃、預算、行李清單、照片及更多功能——全部集中在您自己的伺服器上。",
	...
	"settings.passkey.description": "使用 Passkey 更快登入，並可抵禦網路釣魚——透過你的指紋、臉部、PIN 碼或硬體金鑰。你的密碼仍會保留作為備援。",
	...
	"settings.airtrail.writeBackHint": "預設關閉：AirTrail 是資料來源，memove 僅從中讀取。開啟後會將在 memove 中所做的修改寫回 AirTrail。",
...
//#endregion
//#region src/i18n/zh-TW/share.ts
const share = {
...
//#endregion
//#region src/i18n/zh-TW/shared.ts
const shared = {
...
//#endregion
//#region src/i18n/zh-TW/stats.ts
const stats = {
	"stats.countries": "國家",
	"stats.cities": "城市",
	"stats.trips": "旅行",
...
//#endregion
//#region src/i18n/zh-TW/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "行程規劃器中的​**相片**標籤已被移除。您的相片安全— memove 從未修改您的 Immich 或 Synology 相簿。\n\n相片現在位於 **Journey** 附加元件中。Journey 為選用 — 若尚未啟用，請聯絡管理員於 Admin → 附加元件 中開啟。",
	...
	"system_notice.v3_mcp.body": "MCP 整合已全面重構。OAuth 2.1 現為建議的身份驗證方式。靜態令牌（memove_…）已棄用，將於未來版本移除。",
...
//#endregion
//#region src/i18n/zh-TW/transport.ts
const transport = {
...
//#endregion
//#region src/i18n/zh-TW/trips.ts
const trips = {
...
//#endregion
//#region src/i18n/zh-TW/vacay.ts
const vacay = {
	...
	"vacay.sharing": "共享",
	"vacay.sharingHint": "與其他 memove 使用者共享你的假期計劃",
	"vacay.owner": "所有者",
	"vacay.shareEmailPlaceholder": "memove 使用者郵箱",
	...
	"vacay.inviteHint": "邀請其他 memove 使用者共享合併的假期日曆。",
...
//#endregion
//#region src/i18n/zh-TW/index.ts
const locale = {
	...common,
	...trips,
	...nav,
