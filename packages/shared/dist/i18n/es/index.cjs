...
const admin = {
	...
	"admin.addons.subtitle": "Activa o desactiva funciones para personalizar tu experiencia en memove.",
	...
	"admin.weather.description": "memove utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.",
	...
	"admin.github.support": "Ayuda a seguir desarrollando memove",
	"admin.github.error": "No se pudieron cargar las versiones",
	"admin.github.by": "por",
	"admin.update.available": "Actualización disponible",
	"admin.update.text": "memove {version} está disponible. Estás usando {current}.",
	...
	"admin.update.confirmText": "memove se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.",
	...
	"admin.update.dockerText": "Tu instancia de memove se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:",
	"admin.update.nonDockerText": "Esta instancia de memove no se ejecuta en Docker. Para actualizar a {version}, vuelve a ejecutar el método de instalación o actualización que utilizaste; por ejemplo, en Proxmox Community Scripts ejecuta la actualización desde la consola LXC:",
	...
	"admin.passkey.cardHint": "Permite que los usuarios inicien sesión con passkeys (WebAuthn). Desactivado de forma predeterminada.",
	"admin.passkey.login": "Activar inicio de sesión con passkey",
	"admin.passkey.loginHint": "Muestra una opción \"Iniciar sesión con una passkey\" y permite a los usuarios registrar passkeys en sus ajustes.",
	"admin.passkey.notConfigured": "Aún no se resuelve ningún dominio de WebAuthn para esta instalación. Define APP_URL o el Relying Party ID a continuación: las passkeys permanecerán ocultas hasta entonces.",
	"admin.passkey.rpId": "Relying Party ID (dominio)",
	"admin.passkey.rpIdHint": "El dominio puro al que se vinculan las passkeys, p. ej. memove.example.org. Déjalo vacío para derivarlo de APP_URL. Cambiarlo más adelante invalida las passkeys existentes.",
	"admin.passkey.origins": "Orígenes permitidos",
	"admin.passkey.originsHint": "Orígenes completos separados por comas, p. ej. https://memove.example.org. Déjalo vacío para usar APP_URL.",
	"admin.passkey.reset": "Restablecer passkeys",
	"admin.passkey.resetHint": "Elimina todas las passkeys de este usuario (p. ej. tras perder un dispositivo). Aún podrá iniciar sesión con su contraseña.",
...
//#endregion
//#region src/i18n/es/airport.ts
const airport = { "airport.searchPlaceholder": "Código o ciudad del aeropuerto (ej. FRA)" };
//#endregion
//#region src/i18n/es/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/es/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/es/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/es/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Hecho con memove",
	"journey.pdf.day": "Día",
...
const login = {
	...
	"login.createAdminHint": "Configura la primera cuenta administradora de memove.",
...
//#endregion
//#region src/i18n/es/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} ya está disponible",
...
//#endregion
//#region src/i18n/es/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} ya está disponible.",
	"notifications.versionAvailable.button": "Ver detalles"
};
//#endregion
//#region src/i18n/es/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Busca cada lugar importado para añadir fotos, dirección y datos de contacto. Usa tu clave de Google Maps."
};
//#endregion
//#region src/i18n/es/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/es/register.ts
const register = {
...
//#endregion
//#region src/i18n/es/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/es/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/es/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Al optimizar un día, comienza la ruta en el hotel donde despiertas y termínala en aquel en el que te registras esa noche.",
	...
	"settings.about.supporters.title": "Compañía de viaje para memove",
	"settings.about.supporters.subtitle": "Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de memove. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que memove siga siendo Open Source.",
	...
	"settings.about.description": "memove es un planificador de viajes autoalojado que te ayuda a organizar tus viajes desde la primera idea hasta el último recuerdo. Planificación diaria, presupuesto, listas de equipaje, fotos y mucho más — todo en un solo lugar, en tu propio servidor.",
	...
	"settings.passkey.description": "Inicia sesión más rápido y con protección frente al phishing usando una passkey: tu huella, tu cara, tu PIN o una llave de seguridad física. Tu contraseña sigue disponible como respaldo.",
	"settings.passkey.notConfigured": "Las passkeys están habilitadas, pero aún no están del todo configuradas en este servidor. Pide a tu administrador que defina el dominio de WebAuthn.",
	...
	"settings.airtrail.writeBackHint": "Desactivado por defecto: AirTrail es la fuente de referencia y memove solo lee de él. Actívalo para enviar a AirTrail los cambios hechos en memove.",
...
//#endregion
//#region src/i18n/es/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Fotos** en el Planificador de Viajes han sido eliminadas. Tus fotos están a salvo — memove nunca modificó tu biblioteca de Immich o Synology.\n\nLas fotos ahora viven en el addon **Journey**. Journey es opcional — si aún no está disponible, pide a tu admin que lo active en Admin → Complementos.",
	...
	"system_notice.v3_mcp.body": "La integración MCP ha sido completamente renovada. OAuth 2.1 es ahora el método de autenticación recomendado. Los tokens estáticos (memove_…) están obsoletos y se eliminarán en una versión futura.",
...
//#endregion
//#region src/i18n/es/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Comparte tu calendario de vacaciones con otros usuarios de memove",
	"vacay.owner": "Propietario",
	"vacay.shareEmailPlaceholder": "Correo electrónico del usuario de memove",
	...
	"vacay.inviteHint": "Invita a otro usuario de memove a compartir un calendario combinado de vacaciones.",
