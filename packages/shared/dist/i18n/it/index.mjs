...
const admin = {
	...
	"admin.addons.subtitle": "Abilita o disabilita le funzionalità per personalizzare la tua esperienza memove.",
	...
	"admin.weather.description": "memove utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.",
	...
	"admin.github.by": "da",
	"admin.github.support": "Mi aiuta a continuare a sviluppare memove",
	"admin.update.available": "Aggiornamento disponibile",
	"admin.update.text": "memove {version} è disponibile. Stai eseguendo {current}.",
	...
	"admin.update.confirmText": "memove verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.",
	...
	"admin.update.dockerText": "La tua istanza memove è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:",
	"admin.update.nonDockerText": "Questa istanza memove non è in esecuzione in Docker. Per aggiornare alla versione {version}, riesegui il metodo di installazione o aggiornamento che hai usato — ad esempio, su Proxmox Community Scripts esegui l'aggiornamento dalla console LXC:",
	...
	"admin.passkey.cardHint": "Consenti agli utenti di accedere con le passkey (WebAuthn). Disattivato per impostazione predefinita.",
	"admin.passkey.login": "Abilita accesso con passkey",
	"admin.passkey.loginHint": "Mostra un'opzione \"Accedi con una passkey\" e consenti agli utenti di registrare le passkey nelle loro impostazioni.",
	"admin.passkey.notConfigured": "Nessun dominio WebAuthn è ancora risolto per questa installazione. Imposta APP_URL o il Relying Party ID qui sotto — le passkey restano nascoste fino ad allora.",
	"admin.passkey.rpId": "Relying Party ID (dominio)",
	"admin.passkey.rpIdHint": "Il dominio puro a cui le passkey sono associate, es. memove.example.org. Lascia vuoto per derivarlo da APP_URL. Modificarlo in seguito invalida le passkey esistenti.",
	"admin.passkey.origins": "Origini consentite",
	"admin.passkey.originsHint": "Origini complete separate da virgola, es. https://memove.example.org. Lascia vuoto per usare APP_URL.",
	"admin.passkey.reset": "Reimposta passkey",
	"admin.passkey.resetHint": "Rimuovi tutte le passkey di questo utente (es. in caso di dispositivo smarrito). Potrà comunque accedere con la sua password.",
...
//#endregion
//#region src/i18n/it/airport.ts
const airport = { "airport.searchPlaceholder": "Codice o città dell'aeroporto (es. FRA)" };
//#endregion
//#region src/i18n/it/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/it/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/it/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/it/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Creato con memove",
...
const login = {
	...
	"login.createAdminHint": "Imposta il primo account amministratore per memove.",
...
//#endregion
//#region src/i18n/it/memories.ts
const memories = {
	"memories.title": "Foto",
...
const notif = {
	...
	"notif.version_available.text": "memove {version} è ora disponibile",
...
//#endregion
//#region src/i18n/it/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} è ora disponibile.",
	"notifications.versionAvailable.button": "Visualizza dettagli"
};
//#endregion
//#region src/i18n/it/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Cerca ogni luogo importato per aggiungere foto, indirizzo e contatti. Usa la tua chiave Google Maps."
};
//#endregion
//#region src/i18n/it/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/it/register.ts
const register = {
...
//#endregion
//#region src/i18n/it/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/it/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/it/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Quando ottimizzi un giorno, fa iniziare il percorso dall'hotel in cui ti svegli e terminarlo in quello in cui fai il check-in quella sera.",
	...
	"settings.about.supporters.title": "Compagni di viaggio per memove",
	"settings.about.supporters.subtitle": "Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di memove. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere memove Open Source.",
	...
	"settings.about.description": "memove è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.",
	...
	"settings.passkey.description": "Accedi più velocemente e in modo resistente al phishing con una passkey — la tua impronta digitale, il volto, il PIN o una chiave hardware. La tua password resta come riserva.",
	"settings.passkey.notConfigured": "Le passkey sono abilitate ma non ancora completamente configurate su questo server. Chiedi al tuo amministratore di impostare il dominio WebAuthn.",
	...
	"settings.airtrail.writeBackHint": "Disattivato per impostazione predefinita: AirTrail è la fonte attendibile e memove si limita a leggerlo. Attiva per inviare ad AirTrail le modifiche fatte in memove.",
...
//#endregion
//#region src/i18n/it/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Foto** nel Pianificatore di Viaggio sono state rimosse. Le tue foto sono al sicuro — memove non ha mai modificato la tua libreria Immich o Synology.\n\nLe foto ora si trovano nel componente aggiuntivo **Journey**. Journey è opzionale — se non è ancora disponibile, chiedi al tuo admin di abilitarlo in Admin → Addon.",
	...
	"system_notice.v3_mcp.body": "L'integrazione MCP è stata completamente rinnovata. OAuth 2.1 è ora il metodo di autenticazione consigliato. I token statici (memove_…) sono deprecati e verranno rimossi in una versione futura.",
...
//#endregion
//#region src/i18n/it/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Condividi il tuo piano ferie con altri utenti memove",
	"vacay.owner": "Proprietario",
	"vacay.shareEmailPlaceholder": "Email dell'utente memove",
	...
	"vacay.inviteHint": "Invita un altro utente memove a condividere un calendario ferie combinato.",
