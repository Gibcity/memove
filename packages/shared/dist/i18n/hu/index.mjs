...
const admin = {
	...
	"admin.addons.subtitle": "Funkciók engedélyezése vagy letiltása a memove testreszabásához.",
	...
	"admin.weather.description": "A memove az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.",
	...
	"admin.github.support": "Segít fenntartani a memove fejlesztését",
	"admin.update.available": "Frissítés elérhető",
	"admin.update.text": "A memove {version} elérhető. Jelenleg a {current} verziót használod.",
	...
	"admin.update.confirmText": "A memove frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.",
	...
	"admin.update.dockerText": "A memove példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:",
	"admin.update.nonDockerText": "Ez a memove példány nem Dockerben fut. A {version} verzióra frissítéshez futtasd újra a telepítési vagy frissítési módszert, amelyet használtál — például Proxmox Community Scripts esetén futtasd a frissítést az LXC konzolból:",
	...
	"admin.passkey.cardHint": "Engedélyezd a felhasználóknak a bejelentkezést passkey-vel (WebAuthn). Alapból kikapcsolva.",
	"admin.passkey.login": "Passkey-bejelentkezés engedélyezése",
	"admin.passkey.loginHint": "Jeleníts meg egy „Bejelentkezés passkey-jel\" lehetőséget, és engedd, hogy a felhasználók passkey-ket regisztráljanak a beállításaikban.",
	"admin.passkey.notConfigured": "Ehhez a telepítéshez még nem oldódik fel WebAuthn-domain. Állítsd be az APP_URL-t vagy a lenti Relying Party ID-t — addig a passkey-k rejtve maradnak.",
	"admin.passkey.rpId": "Relying Party ID (domain)",
	"admin.passkey.rpIdHint": "A csupasz domain, amelyhez a passkey-k kötődnek, pl. memove.example.org. Hagyd üresen, hogy az APP_URL-ből legyen levezetve. Későbbi módosítása érvényteleníti a meglévő passkey-ket.",
	"admin.passkey.origins": "Engedélyezett origók",
	"admin.passkey.originsHint": "Vesszővel elválasztott teljes origók, pl. https://memove.example.org. Hagyd üresen az APP_URL használatához.",
	"admin.passkey.reset": "Passkey-k visszaállítása",
	"admin.passkey.resetHint": "Eltávolítja a felhasználó összes passkey-jét (pl. elveszett eszköz esetén). A jelszavukkal továbbra is be tudnak jelentkezni.",
...
//#endregion
//#region src/i18n/hu/airport.ts
const airport = { "airport.searchPlaceholder": "Repülőtér kódja vagy város (pl. FRA)" };
//#endregion
//#region src/i18n/hu/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/hu/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/hu/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/hu/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Készítve a memove segítségével",
	"journey.pdf.day": "Nap",
...
const login = {
	...
	"login.createAdminHint": "Hozd létre az első admin fiókot a memove-hez.",
...
//#endregion
//#region src/i18n/hu/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "A memove {version} elérhető",
...
//#endregion
//#region src/i18n/hu/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "A memove {version} már elérhető.",
	"notifications.versionAvailable.button": "Részletek megtekintése"
};
//#endregion
//#region src/i18n/hu/oauth.ts
const oauth = {
...
const places = {
	...
	"places.enrichOnImportHint": "Minden importált helyet megkeres, hogy fotókat, címet és elérhetőséget adjon hozzá. Google Maps-kulcs szükséges."
};
//#endregion
//#region src/i18n/hu/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/hu/register.ts
const register = {
...
//#endregion
//#region src/i18n/hu/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/hu/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/hu/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "A nap optimalizálásakor az útvonal annál a szállásnál kezdődjön, ahol felébredsz, és annál érjen véget, ahova este bejelentkezel.",
	...
	"settings.about.supporters.title": "Útitársak a memove mellett",
	"settings.about.supporters.subtitle": "Miközben te a következő útvonaladat tervezed, ők a memove jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a memove Open Source maradhasson.",
	...
	"settings.about.description": "A memove egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.",
	...
	"settings.passkey.description": "Jelentkezz be gyorsabban és adathalászat-állóan egy passkey-jel — ujjlenyomattal, arccal, PIN-kóddal vagy hardveres kulccsal. A jelszavad tartalékként megmarad.",
	"settings.passkey.notConfigured": "A passkey-k engedélyezve vannak, de ezen a szerveren még nincsenek teljesen beállítva. Kérd meg a rendszergazdát, hogy állítsa be a WebAuthn-domaint.",
	...
	"settings.airtrail.writeBackHint": "Alapértelmezés szerint kikapcsolva: az AirTrail a hiteles forrás, és a memove csak olvas belőle. Kapcsold be, hogy a memove-ben végzett módosításokat visszaküldje az AirTrailbe.",
...
//#endregion
//#region src/i18n/hu/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "Az útiterv-tervező **Fényképek** lapja eltávolításra került. Fényképeid biztonságban vannak — memove soha nem módosította Immich vagy Synology könyvtáradat.\n\nA fényképek mostantól a **Journey** bővítményben élnek. A Journey opcionális — ha még nem elérhető, kérd meg a rendszergazdát, hogy engedélyezze Admin → Bővítmények alatt.",
	...
	"system_notice.v3_mcp.body": "Az MCP integráció teljesen megújult. Az OAuth 2.1 mostantól az ajánlott hitelesítési módszer. A statikus tokenek (memove_…) elavultak és egy jövőbeli kiadásban eltávolításra kerülnek.",
...
//#endregion
//#region src/i18n/hu/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Szabadságterved megosztása más memove felhasználókkal",
	"vacay.owner": "Tulajdonos",
	"vacay.shareEmailPlaceholder": "memove felhasználó e-mail címe",
	...
	"vacay.inviteHint": "Hívj meg egy másik memove felhasználót közös szabadságnaptár megosztásához.",
