...
const admin = {
	...
	"admin.addons.subtitle": "Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w memove.",
	...
	"admin.weather.description": "memove korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.",
	...
	"admin.github.support": "Pomóż mi rozwijać memove",
	"admin.update.available": "Dostępna aktualizacja",
	"admin.update.text": "Dostępna jest wersja memove {version}. Używasz {current}.",
	...
	"admin.update.confirmText": "memove zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.",
	...
	"admin.update.dockerText": "Twoja instancja memove działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:",
	"admin.update.nonDockerText": "Ta instancja memove nie działa w Dockerze. Aby zaktualizować do {version}, uruchom ponownie metodę instalacji lub aktualizacji, której użyłeś — na przykład w Proxmox Community Scripts uruchom aktualizację z konsoli LXC:",
	...
	"admin.passkey.loginHint": "Pokaż opcję „Zaloguj się kluczem dostępu” i pozwól użytkownikom rejestrować klucze dostępu w swoich ustawieniach.",
	"admin.passkey.notConfigured": "Dla tego wdrożenia nie ustalono jeszcze żadnej domeny WebAuthn. Ustaw APP_URL lub Relying Party ID poniżej — do tego czasu klucze dostępu pozostaną ukryte.",
	"admin.passkey.rpId": "Relying Party ID (domena)",
	"admin.passkey.rpIdHint": "Sama domena, do której przypisane są klucze dostępu, np. memove.example.org. Pozostaw puste, aby wyprowadzić ją z APP_URL. Późniejsza zmiana unieważnia istniejące klucze dostępu.",
	"admin.passkey.origins": "Dozwolone origins",
	"admin.passkey.originsHint": "Pełne origins oddzielone przecinkami, np. https://memove.example.org. Pozostaw puste, aby użyć APP_URL.",
	"admin.passkey.reset": "Zresetuj klucze dostępu",
	"admin.passkey.resetHint": "Usuń wszystkie klucze dostępu tego użytkownika (np. po utracie urządzenia). Nadal będzie mógł logować się hasłem.",
...
//#endregion
//#region src/i18n/pl/airport.ts
const airport = { "airport.searchPlaceholder": "Kod lotniska lub miasto (np. FRA)" };
//#endregion
//#region src/i18n/pl/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/pl/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/pl/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/pl/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Stworzone z memove",
...
const login = {
	...
	"login.createAdminHint": "Skonfiguruj pierwsze konto administratora dla memove.",
...
//#endregion
//#region src/i18n/pl/memories.ts
const memories = {
...
const notif = {
	...
	"notif.version_available.text": "memove {version} jest teraz dostępny",
...
//#endregion
//#region src/i18n/pl/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} jest już dostępny.",
...
const places = {
	...
	"places.enrichOnImportHint": "Wyszukuje każde zaimportowane miejsce, aby dodać zdjęcia, adres i dane kontaktowe. Wymaga klucza Google Maps."
};
//#endregion
//#region src/i18n/pl/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/pl/register.ts
const register = {
...
//#endregion
//#region src/i18n/pl/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/pl/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/pl/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Przy optymalizacji dnia rozpocznij trasę w hotelu, w którym się budzisz, a zakończ ją w tym, do którego się zameldujesz tego wieczoru.",
	...
	"settings.about.supporters.title": "Towarzystwo podróży dla memove",
	"settings.about.supporters.subtitle": "Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość memove. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby memove pozostał Open Source.",
	...
	"settings.about.description": "memove to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.",
	...
	"settings.passkey.description": "Loguj się szybciej i z odpornością na phishing za pomocą klucza dostępu — odcisku palca, twarzy, kodu PIN lub klucza sprzętowego. Twoje hasło pozostaje jako zapasowa opcja.",
	"settings.passkey.notConfigured": "Klucze dostępu są włączone, ale nie zostały jeszcze w pełni skonfigurowane na tym serwerze. Poproś administratora o ustawienie domeny WebAuthn.",
	"settings.passkey.add": "Dodaj klucz dostępu",
	"settings.passkey.addTitle": "Dodaj klucz dostępu",
	"settings.passkey.passwordPrompt": "Potwierdź swoje aktualne hasło, a następnie postępuj zgodnie z komunikatem na urządzeniu.",
	...
	"settings.airtrail.writeBackHint": "Domyślnie wyłączone: AirTrail jest źródłem prawdy, a memove tylko z niego odczytuje. Włącz, aby wysyłać zmiany wprowadzone w memove z powrotem do AirTrail.",
...
//#endregion
//#region src/i18n/pl/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Zdjęcia** w Planerze Podróży zostały usunięte. Twoje zdjęcia są bezpieczne — memove nigdy nie modyfikował Twojej biblioteki Immich lub Synology.\n\nZdjęcia są teraz dostępne w dodatku **Journey**. Journey jest opcjonalny — jeśli jeszcze nie jest dostępny, poproś administratora o jego włączenie w Admin → Dodatki.",
	...
	"system_notice.v3_mcp.body": "Integracja MCP została całkowicie przeprojektowana. OAuth 2.1 jest teraz zalecaną metodą uwierzytelniania. Statyczne tokeny (memove_…) są przestarzałe i zostaną usunięte w przyszłej wersji.",
...
//#endregion
//#region src/i18n/pl/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Udostępnij swój plan urlopów innym użytkownikom memove",
	"vacay.owner": "Właściciel",
	"vacay.shareEmailPlaceholder": "E-mail użytkownika memove",
	...
	"vacay.inviteHint": "Zaproś innego użytkownika memove do wspólnego kalendarza urlopów.",
