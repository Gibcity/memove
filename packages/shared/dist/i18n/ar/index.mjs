...
const admin = {
	...
	"admin.addons.subtitle": "فعّل أو عطّل الميزات لتخصيص تجربة memove.",
	...
	"admin.weather.description": "يستخدم memove خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.",
	...
	"admin.github.support": "يساعدني في تطوير memove",
	"admin.update.available": "يتوفر تحديث",
	"admin.update.text": "memove {version} متوفر. أنت تستخدم {current}.",
	"admin.update.button": "عرض على GitHub",
	"admin.update.install": "تثبيت التحديث",
	"admin.update.confirmTitle": "تثبيت التحديث؟",
	"admin.update.confirmText": "سيتم تحديث memove من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.",
	...
	"admin.update.dockerText": "يعمل memove الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:",
	"admin.update.nonDockerText": "لا يعمل memove هذا في Docker. للتحديث إلى {version}، أعد تشغيل طريقة التثبيت أو التحديث التي استخدمتها — على سبيل المثال، في Proxmox Community Scripts نفّذ التحديث من وحدة تحكم LXC:",
	...
	"admin.passkey.notConfigured": "لا يوجد نطاق WebAuthn صالح لهذا التثبيت بعد. عيّن APP_URL أو Relying Party ID أدناه — تبقى مفاتيح المرور مخفية حتى ذلك الحين.",
	"admin.passkey.rpId": "Relying Party ID (النطاق)",
	"admin.passkey.rpIdHint": "النطاق المجرّد الذي تُربط به مفاتيح المرور، مثل memove.example.org. اتركه فارغًا لاشتقاقه من APP_URL. تغييره لاحقًا يُبطل مفاتيح المرور الموجودة.",
	"admin.passkey.origins": "الأصول المسموح بها",
	"admin.passkey.originsHint": "أصول كاملة مفصولة بفواصل، مثل https://memove.example.org. اتركه فارغًا لاستخدام APP_URL.",
	"admin.passkey.reset": "إعادة تعيين مفاتيح المرور",
	"admin.passkey.resetHint": "إزالة جميع مفاتيح المرور لهذا المستخدم (مثلًا عند فقدان جهاز). سيظل بإمكانه تسجيل الدخول بكلمة المرور.",
...
//#endregion
//#region src/i18n/ar/airport.ts
const airport = { "airport.searchPlaceholder": "رمز المطار أو المدينة (مثل FRA)" };
//#endregion
//#region src/i18n/ar/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/ar/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/ar/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/ar/inspector.ts
const inspector = {
...
const login = {
	...
	"login.createAdminHint": "أعد إعداد أول حساب مسؤول لـ memove.",
...
//#endregion
//#region src/i18n/ar/memories.ts
const memories = {
	"memories.title": "صور",
...
const notif = {
	...
	"notif.version_available.text": "memove {version} متاح الآن",
...
//#endregion
//#region src/i18n/ar/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} متاح الآن.",
...
const places = {
	...
	"places.enrichOnImportHint": "يبحث عن كل مكان مستورد لإضافة الصور والعنوان وبيانات الاتصال. يتطلب مفتاح خرائط Google."
};
//#endregion
//#region src/i18n/ar/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/ar/register.ts
const register = {
...
//#endregion
//#region src/i18n/ar/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/ar/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/ar/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "عند تحسين يوم ما، يبدأ المسار من الفندق الذي تستيقظ فيه وينتهي عند الفندق الذي تسجّل الوصول إليه في تلك الليلة.",
	...
	"settings.about.supporters.title": "رفاق رحلة memove",
	"settings.about.supporters.subtitle": "بينما تخطّط لمسارك التالي، يساعد هؤلاء الأشخاص في التخطيط لمستقبل memove. تذهب مساهمتهم الشهرية مباشرةً إلى التطوير والساعات الفعلية المبذولة — حتى يظلّ memove مفتوح المصدر.",
	"settings.about.supporters.since": "داعم منذ {date}",
	"settings.about.supporters.tierEmpty": "كن الأول",
	"settings.about.description": "memove هو مخطط سفر مستضاف ذاتيًا يساعدك على تنظيم رحلاتك من أول فكرة حتى آخر ذكرى. تخطيط يومي، ميزانية، قوائم تعبئة، صور والمزيد — كل شيء في مكان واحد، على خادمك الخاص.",
	...
	"settings.passkey.description": "سجّل الدخول بشكل أسرع وأكثر مقاومة للتصيّد باستخدام مفتاح مرور — ببصمة إصبعك أو وجهك أو رمز PIN أو مفتاح أمان مادي. تبقى كلمة المرور كنسخة احتياطية.",
	"settings.passkey.notConfigured": "مفاتيح المرور مفعّلة لكنها لم تُهيّأ بالكامل على هذا الخادم بعد. اطلب من المسؤول تعيين نطاق WebAuthn.",
	...
	"settings.airtrail.writeBackHint": "مُعطّل افتراضيًا: AirTrail هو مصدر الحقيقة وmemove يقرأ منه فقط. فعّله لإرسال التعديلات التي تجريها في memove إلى AirTrail.",
...
const system_notice = {
	...
	"system_notice.v3_mcp.body": "تمت إعادة تصميم تكامل MCP بالكامل. OAuth 2.1 هو الآن طريقة المصادقة الموصى بها. الرموز الثابتة (memove_…) مهملة وستُزال في إصدار مستقبلي.",
...
//#endregion
//#region src/i18n/ar/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "شارك خطة إجازاتك مع مستخدمي memove الآخرين",
	"vacay.owner": "المالك",
	"vacay.shareEmailPlaceholder": "البريد الإلكتروني لمستخدم memove",
	...
	"vacay.inviteHint": "ادعُ مستخدم memove آخرًا لمشاركة تقويم إجازة مشترك.",
