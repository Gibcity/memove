...
const admin = {
	...
	"admin.addons.subtitle": "Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman memove kamu.",
	...
	"admin.weather.description": "memove menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.",
	...
	"admin.github.support": "Bantu saya terus mengembangkan memove",
	"admin.update.available": "Pembaruan tersedia",
	"admin.update.text": "memove {version} tersedia. Kamu menggunakan {current}.",
	"admin.update.button": "Lihat di GitHub",
	"admin.update.install": "Pasang Pembaruan",
	"admin.update.confirmTitle": "Pasang Pembaruan?",
	"admin.update.confirmText": "memove akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.",
	...
	"admin.update.dockerText": "Instans memove kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:",
	"admin.update.nonDockerText": "Instans memove ini tidak berjalan di Docker. Untuk memperbarui ke {version}, jalankan ulang metode instalasi atau pembaruan yang kamu gunakan — misalnya, pada Proxmox Community Scripts jalankan pembaruan dari konsol LXC:",
	...
	"admin.passkey.loginHint": "Tampilkan opsi \"Masuk dengan passkey\" dan izinkan pengguna mendaftarkan passkey di pengaturan mereka.",
	"admin.passkey.notConfigured": "Belum ada domain WebAuthn yang terdeteksi untuk deployment ini. Atur APP_URL atau Relying Party ID di bawah — passkey tetap tersembunyi sampai itu dilakukan.",
	"admin.passkey.rpId": "Relying Party ID (domain)",
	"admin.passkey.rpIdHint": "Domain murni tempat passkey diikat, mis. memove.example.org. Kosongkan untuk mengambilnya dari APP_URL. Mengubahnya nanti akan membatalkan passkey yang sudah ada.",
	"admin.passkey.origins": "Origin yang diizinkan",
	"admin.passkey.originsHint": "Origin lengkap dipisahkan koma, mis. https://memove.example.org. Kosongkan untuk menggunakan APP_URL.",
	"admin.passkey.reset": "Reset passkey",
	"admin.passkey.resetHint": "Hapus semua passkey pengguna ini (mis. saat perangkat hilang). Mereka tetap bisa masuk dengan kata sandi mereka.",
...
//#endregion
//#region src/i18n/id/airport.ts
const airport = { "airport.searchPlaceholder": "Kode bandara atau kota (mis. FRA)" };
//#endregion
//#region src/i18n/id/atlas.ts
const atlas = {
...
//#endregion
//#region src/i18n/id/categories.ts
const categories = {
...
//#endregion
//#region src/i18n/id/dashboard.ts
const dashboard = {
...
//#endregion
//#region src/i18n/id/inspector.ts
const inspector = {
...
const journey = {
	...
	"journey.pdf.madeWith": "Dibuat dengan memove",
...
const login = {
	...
	"login.createAdminHint": "Siapkan akun admin pertama untuk memove.",
...
//#endregion
//#region src/i18n/id/memories.ts
const memories = {
	"memories.title": "Foto",
...
const notif = {
	...
	"notif.version_available.text": "memove {version} kini tersedia",
...
//#endregion
//#region src/i18n/id/notifications.ts
const notifications = {
	...
	"notifications.versionAvailable.text": "memove {version} kini tersedia.",
...
const places = {
	...
	"places.gpxImportTracks": "memove (dengan geometri jalur)",
	...
	"places.enrichOnImportHint": "Mencari setiap tempat yang diimpor untuk menambahkan foto, alamat, dan kontak. Memerlukan kunci Google Maps."
};
//#endregion
//#region src/i18n/id/planner.ts
const planner = {
...
//#endregion
//#region src/i18n/id/register.ts
const register = {
...
//#endregion
//#region src/i18n/id/relocation.ts
const relocation = {
...
//#endregion
//#region src/i18n/id/reservations.ts
const reservations = {
...
//#endregion
//#region src/i18n/id/settings.ts
const settings = {
	...
	"settings.optimizeFromAccommodationHint": "Saat mengoptimalkan suatu hari, mulai rute dari hotel tempatmu bangun pagi dan akhiri di hotel tempatmu check-in malam itu.",
	...
	"settings.about.supporters.title": "Rekan perjalanan untuk memove",
	"settings.about.supporters.subtitle": "Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan memove. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya memove tetap Open Source.",
	...
	"settings.about.description": "memove adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.",
	...
	"settings.passkey.description": "Masuk lebih cepat dan tahan terhadap phishing dengan passkey — sidik jari, wajah, PIN, atau kunci keamanan fisik kamu. Kata sandimu tetap tersedia sebagai cadangan.",
	"settings.passkey.notConfigured": "Passkey diaktifkan tetapi belum sepenuhnya dikonfigurasi di server ini. Minta administratormu untuk mengatur domain WebAuthn.",
	...
	"settings.airtrail.writeBackHint": "Nonaktif secara bawaan: AirTrail adalah sumber kebenaran dan memove hanya membaca darinya. Aktifkan untuk mengirim perubahan yang dibuat di memove kembali ke AirTrail.",
...
//#endregion
//#region src/i18n/id/system_notice.ts
const system_notice = {
	...
	"system_notice.v3_photos.body": "**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman — memove tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional — jika belum tersedia, minta admin untuk mengaktifkannya di Admin → Addon.",
	...
	"system_notice.v3_mcp.body": "Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (memove_…) sudah usang dan akan dihapus pada versi mendatang.",
...
//#endregion
//#region src/i18n/id/transport.ts
const transport = {
...
const vacay = {
	...
	"vacay.sharingHint": "Bagikan rencana cuti kamu dengan pengguna memove lainnya",
	"vacay.owner": "Pemilik",
	"vacay.shareEmailPlaceholder": "Email pengguna memove",
	...
	"vacay.inviteHint": "Undang pengguna memove lain untuk berbagi kalender cuti bersama.",
