...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр memove працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр memove не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Чистий домен, до якого прив’язані passkeys, напр. memove.example.org. Залиште порожнім, щоб визначити його з APP_URL. Подальша зміна робить наявні passkeys недійсними.',
  'admin.passkey.origins': 'Дозволені джерела (origins)',
  'admin.passkey.originsHint':
    'Повні джерела через кому, напр. https://memove.example.org. Залиште порожнім, щоб використати APP_URL.',
