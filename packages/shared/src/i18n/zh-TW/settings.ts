...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    '當你規劃下一段路線時，這些人也在一起規劃 memove 的未來。他們每月的支持直接用於開發與實際投入的時間——讓 memove 保持開源。',
  ...
  'settings.about.description':
    'memove 是一款自架旅遊規劃器，幫助您從最初構想到最後回憶，整理每次旅行。日程規劃、預算、行李清單、照片及更多功能——全部集中在您自己的伺服器上。',
  ...
  'settings.airtrail.writeBackHint':
    '預設關閉：AirTrail 是資料來源，memove 僅從中讀取。開啟後會將在 memove 中所做的修改寫回 AirTrail。',
