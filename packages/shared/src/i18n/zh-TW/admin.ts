...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.update.nonDockerText':
    '此 memove 例項並非執行在 Docker 中。要更新到 {version}，請重新執行你當初使用的安裝或更新方式——例如在 Proxmox Community Scripts 上，請從 LXC 主控臺執行更新：',
  ...
  'admin.passkey.rpIdHint':
    'Passkey 綁定的純網域，例如 memove.example.org。留空則從 APP_URL 推導。日後變更將使現有 Passkey 失效。',
