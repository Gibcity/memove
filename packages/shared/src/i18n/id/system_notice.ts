...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Selamat datang di memove',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka memove',
  ...
  'system_notice.v3_photos.body':
    '**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman — memove tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional — jika belum tersedia, minta admin untuk mengaktifkannya di Admin → Addon.',
  ...
  'system_notice.v3_mcp.body':
    'Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (memove_…) sudah usang dan akan dihapus pada versi mendatang.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statis memove_ sudah usang',
