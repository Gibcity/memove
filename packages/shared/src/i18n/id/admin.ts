...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.update.confirmText':
    'memove akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'admin.update.dockerText':
    'Instans memove kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  'admin.update.nonDockerText':
    'Instans memove ini tidak berjalan di Docker. Untuk memperbarui ke {version}, jalankan ulang metode instalasi atau pembaruan yang kamu gunakan — misalnya, pada Proxmox Community Scripts jalankan pembaruan dari konsol LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Domain murni tempat passkey diikat, mis. memove.example.org. Kosongkan untuk mengambilnya dari APP_URL. Mengubahnya nanti akan membatalkan passkey yang sudah ada.',
  'admin.passkey.origins': 'Origin yang diizinkan',
  'admin.passkey.originsHint':
    'Origin lengkap dipisahkan koma, mis. https://memove.example.org. Kosongkan untuk menggunakan APP_URL.',
