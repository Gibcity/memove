...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan memove. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya memove tetap Open Source.',
  ...
  'settings.about.description':
    'memove adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.',
  ...
  'settings.airtrail.writeBackHint':
    'Nonaktif secara bawaan: AirTrail adalah sumber kebenaran dan memove hanya membaca darinya. Aktifkan untuk mengirim perubahan yang dibuat di memove kembali ke AirTrail.',
