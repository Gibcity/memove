...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.update.confirmText':
    'memove sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText':
    'Votre instance memove fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  'admin.update.nonDockerText':
    "Cette instance memove ne fonctionne pas dans Docker. Pour mettre à jour vers {version}, relancez la méthode d'installation ou de mise à jour que vous avez utilisée — par exemple, sur Proxmox Community Scripts, lancez la mise à jour depuis la console LXC :",
  ...
  'admin.passkey.rpIdHint':
    "Le domaine nu auquel les passkeys sont liées, ex. memove.example.org. Laissez vide pour le déduire d'APP_URL. Le modifier ultérieurement invalide les passkeys existantes.",
  'admin.passkey.origins': 'Origines autorisées',
  'admin.passkey.originsHint':
    'Origines complètes séparées par des virgules, ex. https://memove.example.org. Laissez vide pour utiliser APP_URL.',
