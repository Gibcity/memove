...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.update.dockerText':
    "Je memove-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  'admin.update.nonDockerText':
    'Deze memove-instantie draait niet in Docker. Om bij te werken naar {version}, voer de installatie- of updatemethode die je hebt gebruikt opnieuw uit — bij Proxmox Community Scripts voer je de update bijvoorbeeld uit vanuit de LXC-console:',
  ...
  'admin.passkey.rpIdHint':
    'Het kale domein waaraan passkeys zijn gebonden, bijv. memove.example.org. Laat leeg om het af te leiden uit APP_URL. Als je dit later wijzigt, worden bestaande passkeys ongeldig.',
  'admin.passkey.origins': 'Toegestane origins',
  'admin.passkey.originsHint':
    "Volledige origins, gescheiden door komma's, bijv. https://memove.example.org. Laat leeg om APP_URL te gebruiken.",
