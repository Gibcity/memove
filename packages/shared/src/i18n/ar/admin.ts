...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'يستخدم memove خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.update.nonDockerText':
    'لا يعمل memove هذا في Docker. للتحديث إلى {version}، أعد تشغيل طريقة التثبيت أو التحديث التي استخدمتها — على سبيل المثال، في Proxmox Community Scripts نفّذ التحديث من وحدة تحكم LXC:',
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'memove-admin-alerts', // en-fallback
  ...
  'admin.passkey.rpIdHint':
    'النطاق المجرّد الذي تُربط به مفاتيح المرور، مثل memove.example.org. اتركه فارغًا لاشتقاقه من APP_URL. تغييره لاحقًا يُبطل مفاتيح المرور الموجودة.',
  'admin.passkey.origins': 'الأصول المسموح بها',
  'admin.passkey.originsHint':
    'أصول كاملة مفصولة بفواصل، مثل https://memove.example.org. اتركه فارغًا لاستخدام APP_URL.',
