...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.confirmText':
    'memove bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText':
    'Váš memove běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  'admin.update.nonDockerText':
    'Tato instance memove neběží v Dockeru. Pro aktualizaci na verzi {version} znovu spusťte instalační nebo aktualizační metodu, kterou jste použili — například u Proxmox Community Scripts spusťte aktualizaci z konzole LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Holá doména, ke které jsou přístupové klíče vázány, např. memove.example.org. Ponechte prázdné, aby se odvodila z APP_URL. Pozdější změna zneplatní stávající přístupové klíče.',
  'admin.passkey.origins': 'Povolené origins',
  'admin.passkey.originsHint':
    'Úplné origins oddělené čárkou, např. https://memove.example.org. Ponechte prázdné pro použití APP_URL.',
