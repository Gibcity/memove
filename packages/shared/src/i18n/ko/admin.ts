...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove은 날씨 데이터 소스로 Open-Meteo를 사용합니다. Open-Meteo는 무료 오픈 소스 날씨 서비스로 API 키가 필요 없습니다.',
  ...
  'admin.update.dockerText':
    'memove 인스턴스가 Docker에서 실행 중입니다. {version}으로 업데이트하려면 서버에서 다음 명령을 실행하세요:',
  'admin.update.nonDockerText':
    '이 memove 인스턴스는 Docker에서 실행되고 있지 않습니다. {version}으로 업데이트하려면 사용했던 설치 또는 업데이트 방법을 다시 실행하세요 — 예를 들어 Proxmox Community Scripts에서는 LXC 콘솔에서 업데이트를 실행하세요:',
  ...
  'admin.passkey.rpIdHint':
    '패스키가 바인딩되는 순수 도메인입니다. 예: memove.example.org. 비워두면 APP_URL에서 자동으로 가져옵니다. 나중에 변경하면 기존 패스키가 무효화됩니다.',
  'admin.passkey.origins': '허용된 오리진',
  'admin.passkey.originsHint':
    '쉼표로 구분된 전체 오리진입니다. 예: https://memove.example.org. 비워두면 APP_URL을 사용합니다.',
