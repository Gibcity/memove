...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    '다음 여정을 계획하는 동안, 이분들이 memove의 미래를 함께 만들어가고 있습니다. 월간 후원금은 개발과 실제 작업 시간에 직접 사용되어 memove이 오픈 소스로 유지될 수 있게 합니다.',
  ...
  'settings.about.description':
    'memove은 첫 아이디어부터 마지막 추억까지 여행을 체계적으로 관리하는 자체 호스팅 여행 플래너입니다. 일별 계획, 예산, 짐 목록, 사진 등 모든 것이 하나의 서버에 담겨 있습니다.',
  ...
  'settings.airtrail.writeBackHint':
    '기본적으로 꺼져 있음: AirTrail이 신뢰할 수 있는 원본이며 memove은 읽기만 합니다. memove에서 변경한 내용을 AirTrail로 다시 보내려면 켜세요.',
