...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.update.confirmText':
    'memove wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText':
    'Deine memove-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  'admin.update.nonDockerText':
    'Diese memove-Instanz läuft nicht in Docker. Um auf {version} zu aktualisieren, führe die Installations- oder Update-Methode erneut aus, die du verwendet hast — bei Proxmox Community Scripts startest du das Update zum Beispiel über die LXC-Konsole:',
  ...
  'admin.passkey.rpIdHint':
    'Die reine Domain, an die Passkeys gebunden sind, z. B. memove.example.org. Leer lassen, um sie aus APP_URL abzuleiten. Eine spätere Änderung macht bestehende Passkeys ungültig.',
  'admin.passkey.origins': 'Erlaubte Origins',
  'admin.passkey.originsHint':
    'Vollständige Origins, durch Komma getrennt, z. B. https://memove.example.org. Leer lassen, um APP_URL zu verwenden.',
