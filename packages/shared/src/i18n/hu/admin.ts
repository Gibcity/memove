...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'A memove az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.update.confirmText':
    'A memove frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText':
    'A memove példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  'admin.update.nonDockerText':
    'Ez a memove példány nem Dockerben fut. A {version} verzióra frissítéshez futtasd újra a telepítési vagy frissítési módszert, amelyet használtál — például Proxmox Community Scripts esetén futtasd a frissítést az LXC konzolból:',
  ...
  'admin.passkey.rpIdHint':
    'A csupasz domain, amelyhez a passkey-k kötődnek, pl. memove.example.org. Hagyd üresen, hogy az APP_URL-ből legyen levezetve. Későbbi módosítása érvényteleníti a meglévő passkey-ket.',
  'admin.passkey.origins': 'Engedélyezett origók',
  'admin.passkey.originsHint':
    'Vesszővel elválasztott teljes origók, pl. https://memove.example.org. Hagyd üresen az APP_URL használatához.',
