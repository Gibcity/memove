...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'O memove usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.update.confirmText':
    'O memove será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.nonDockerText':
    'Esta instância do memove não está rodando no Docker. Para atualizar para {version}, execute novamente o método de instalação ou atualização que você usou — por exemplo, no Proxmox Community Scripts, execute a atualização a partir do console do LXC:',
  ...
  'admin.passkey.rpIdHint':
    'O domínio puro ao qual as passkeys ficam vinculadas, ex.: memove.example.org. Deixe vazio para derivá-lo de APP_URL. Alterá-lo depois invalida as passkeys existentes.',
  'admin.passkey.origins': 'Origens permitidas',
  'admin.passkey.originsHint':
    'Origens completas separadas por vírgula, ex.: https://memove.example.org. Deixe vazio para usar APP_URL.',
