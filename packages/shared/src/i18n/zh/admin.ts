...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'memove 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.update.nonDockerText':
    '此 memove 实例未运行在 Docker 中。要更新到 {version}，请重新执行你当初使用的安装或更新方式——例如，在 Proxmox Community Scripts 上，从 LXC 控制台运行更新：',
  ...
  'admin.passkey.rpIdHint':
    '通行密钥所绑定的纯域名，如 memove.example.org。留空则从 APP_URL 推导。之后更改将使现有通行密钥失效。',
