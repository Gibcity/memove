...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    '当你在规划下一段路线时，这些人也在一起规划 memove 的未来。他们每月的支持直接用于开发与真实投入的时间——让 memove 保持开源。',
  ...
  'settings.about.description':
    'memove 是一个自托管的旅行规划工具，帮助你从最初的想法到最后的回忆，全程组织你的旅行。日程规划、预算、行李清单、照片等——一切尽在一处，在你自己的服务器上。',
  ...
  'settings.airtrail.writeBackHint':
    '默认关闭：AirTrail 是数据来源，memove 仅从中读取。开启后会将在 memove 中所做的修改写回 AirTrail。',
