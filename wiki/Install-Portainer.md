...
2. Give the stack a name (e.g. `memove`).
3. Select **Web editor** and paste the compose file from [docker-compose.yml](https://github.com/Gibcity/memove/blob/main/docker-compose.yml).
