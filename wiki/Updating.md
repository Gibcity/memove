...
How to update memove to a newer version without losing data.
...
Open the **Stacks** list, click the memove stack, then click **Redeploy**.
...
In the Unraid Docker tab, click the memove container and select **Update**. Unraid will pull the latest image and restart with the same volumes.
