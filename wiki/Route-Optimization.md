...
memove calculates walking and driving times between your places and can reorder them to minimize total travel distance.
...
memove uses **OSRM** (Open Source Routing Machine) to calculate routes between consecutive places in the selected day. No API key is required.
