...
The Map tab (Settings → Map) controls which map engine and tile source memove uses in the Trip Planner and Journey maps. Changes take effect after clicking **Save map settings**.
