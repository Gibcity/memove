...
The Settings page lets you personalise every aspect of memove — appearance, maps, notifications, offline behaviour, and your account.
...
If your account requires MFA setup, memove redirects you directly to the **Account** tab (via `?mfa=required`).
